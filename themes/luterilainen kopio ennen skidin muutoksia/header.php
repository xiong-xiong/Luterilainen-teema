...
<i class="fa fa-bookmark logoicon"></i>
<h1>Luterilainen.Net</h1>
</div> <!-- /row -->
  <div class="row"></div>
    <div class="nav-bar-main">
        <div class="corner" id="corner1"></div><div class="corner" id="corner2"></div>
               <?php wp_nav_menu( array( 'theme_location' => 'main-menu', 'container_class' => 'main-nav', 'container' => 'nav' )); ?> 
               <div class="corner" id="corner3"></div><div class="corner" id="corner4"></div>
        </div>
    </div> <!-- /row -->
</div><!--/Container -->
