...
<div class="container">
  ...
  <div class="col-md-6 singlecontent">
   ...
   <center><img class="printlogo" src="<?php bloginfo('template_url'); ?>/img/grey-bg-logo.png"></center>
  ...
  <center><?php the_post_thumbnail('nosto'); ?>
 	...
 	<div class="singlemeta"><?php the_date(); ?>  • <?php the_category(' / ', 'multiple', '' ); ?> </div></center>
      ...
      <div class="singlecontentp"><?php the_content(); ?> <?php dynamic_sidebar('post_bottom_sidebar' ); ?></div>
      </div><!--colmd6 -->
<div class="col-md-3">
