...
$args = array( 'post_type' => 'post', 'category_name' => 'ydinkohdat', 'orderby' => 'title', 'order' => 'ASC', 'posts_per_page' => 10, 'paged' => $paged );
...
<div class="col-md-6 kaikki">
<!--LOOP  -->
<?php
global $post;
$args = array( 'posts_per_page' => 900, 'category_name' => 'ydinkohdat', 'orderby' => 'title', 'order' => 'ASC' );
...
<div class="col-md-3">
  <span id="naytakaikki">Näytä kaikki <i class="fa fa-chevron-right"></i></span>
